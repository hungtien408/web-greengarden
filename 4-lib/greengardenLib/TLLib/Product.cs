...
namespace TLLib
{
    public class Product
    {
        ...
        public string ProductInsert2(
            ...
            string Priority,
            string IsAvailable,
            string DienTichKhuDat,
            string MatDoXayDung,
            string KhongGianXanh,
            string DienTichXayDung,
            string SoBlock,
            string SoTang
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Priority", string.IsNullOrEmpty(Priority) ? dbNULL : (object)Priority);
                cmd.Parameters.AddWithValue("@IsAvailable", string.IsNullOrEmpty(IsAvailable) ? dbNULL : (object)IsAvailable);
                cmd.Parameters.AddWithValue("@DienTichKhuDat", string.IsNullOrEmpty(DienTichKhuDat) ? dbNULL : (object)DienTichKhuDat);
                cmd.Parameters.AddWithValue("@MatDoXayDung", string.IsNullOrEmpty(MatDoXayDung) ? dbNULL : (object)MatDoXayDung);
                cmd.Parameters.AddWithValue("@KhongGianXanh", string.IsNullOrEmpty(KhongGianXanh) ? dbNULL : (object)KhongGianXanh);
                cmd.Parameters.AddWithValue("@DienTichXayDung", string.IsNullOrEmpty(DienTichXayDung) ? dbNULL : (object)DienTichXayDung);
                cmd.Parameters.AddWithValue("@SoBlock", string.IsNullOrEmpty(SoBlock) ? dbNULL : (object)SoBlock);
                cmd.Parameters.AddWithValue("@SoTang", string.IsNullOrEmpty(SoTang) ? dbNULL : (object)SoTang);

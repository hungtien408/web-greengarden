<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="tongquan.aspx.cs" Inherits="ad_single_product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                                                ...
                                                <table class="search">
                                                    <tr class="invisible">
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 500px x 317px)</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDienTichKhuDat" runat="server" Width="500px" Text='<%# Bind("DienTichKhuDat") %>'
                                                                EmptyMessage="Diện tích khu đất...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtMatDoXayDung" runat="server" Width="500px" Text='<%# Bind("MatDoXayDung") %>'
                                                                EmptyMessage="Mật độ xây dựng...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtKhongGianXanh" runat="server" Width="500px" Text='<%# Bind("KhongGianXanh") %>'
                                                                EmptyMessage="Không gian xanh...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDienTichXayDung" runat="server" Width="500px" Text='<%# Bind("DienTichXayDung") %>'
                                                                EmptyMessage="Diện tích xây dựng...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtSoBlock" runat="server" Width="500px" Text='<%# Bind("SoBlock") %>'
                                                                EmptyMessage="Số block...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtSoTang" runat="server" Width="500px" Text='<%# Bind("SoTang") %>'
                                                                EmptyMessage="Số tầng...">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDescription" runat="server" Text='<%# Bind("Description") %>'
                                                                Width="500px" EmptyMessage="Tiện ích" TextMode="MultiLine" Height="200">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr class="invisible">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="DienTichKhuDat" Type="String" />
            <asp:Parameter Name="MatDoXayDung" Type="String" />
            <asp:Parameter Name="KhongGianXanh" Type="String" />
            <asp:Parameter Name="DienTichXayDung" Type="String" />
            <asp:Parameter Name="SoBlock" Type="String" />
            <asp:Parameter Name="SoTang" Type="String" />
        </InsertParameters>
        <SelectParameters>
